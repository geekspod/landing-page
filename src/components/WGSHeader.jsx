    ...
    <div className="relative bg-gray-800" style={{ backgroundImage: `linear-gradient(180deg, #1A27C8 0%, #0D1465 100%)`}}>
            ...
            <div className="relative max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
                <div className="md:ml-auto md:w-1/2 md:pl-10">
                    ...
                    Luckily, we are here to help. Our vetting and scrutiny processes make sure that we hire the perfect geeks for you! So all that&appos;s left for you to do is consult us.        </p>             <div className="mt-8">
